                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          isdelete = !isdelete;
                                          ProducteDeleted.add(F_item);
                                          classInstancee.removeProducte(F_item);
                                          ...
                                          onTap: () {
                                            setState(() {
                                              ...
                                              double calculatedPrice =
                                                  F_item.count * F_item.Price;
                                              if (calculatedPrice == 0) {
                                                classInstancee
                                                    .removeProducte(F_item);
