...
class _NavigationBottomBarState extends State<NavigationBottomBar> {
  final Navigationbottombarmodel _navigationbottombarmodel =
      Navigationbottombarmodel(); // this is the view model that hold the logic of this page

  void _bind() {
    _navigationbottombarmodel
        .start(); // this function will start the view model and get the data from it
  }
