...
class Navigationbottombarmodel extends Baseviewmodel
    implements Naviagationbottombarinputs, Naviagationbottombaroutputs {
  int _selectIndex = 0;
  ...
  Stream<int> get outputsselctedindex =>
      _streamController.stream.map((index) => index);
